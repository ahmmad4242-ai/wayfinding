# محلل التوجيه الأكاديمي للمستشفيات 🏥

نظام متكامل لتحليل مخططات الطوابق بمنهجيات أكاديمية محكّمة لتقييم كفاءة التوجيه (Wayfinding)

[![Academic Grade](https://img.shields.io/badge/Academic-Grade-green.svg)](ACADEMIC_METHODOLOGY.md)
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](CHANGELOG.md)
[![License](https://img.shields.io/badge/license-MIT-orange.svg)](LICENSE)

## 🎓 نظرة عامة

**محلل التوجيه الأكاديمي** هو نظام بحثي متقدم لتقييم كفاءة التوجيه (Wayfinding) في المستشفيات باستخدام منهجيات أكاديمية محكّمة منشورة في مجلات علمية عالمية.

### 🔬 الأساس العلمي
النظام مبني على أبحاث من:
- **Hillier & Hanson (1984)**: Space Syntax Theory
- **Benedikt (1979) & Turner (2001)**: VGA & Isovists
- **Huang et al. (2017)**: Agent-Based Simulation
- **O'Neill (1992)**: Decision Load & Cognitive Burden
- **Hölscher et al. (2006)**: Straightness Preference
- **Rousek & Hallbeck (2011)**: Healthcare Signage
- **McLachlan & Leng (2011)**: Color Coding

📖 [قراءة المنهجية الأكاديمية الكاملة](ACADEMIC_METHODOLOGY.md)
...
#### 🚶 تحليل التوجيه الأكاديمي (Academic Wayfinding) ⭐ NEW!

##### 1️⃣ Space Syntax Analysis (Hillier)
- **Integration (RA/RRA)**: قياس مدى "ضحالة" المساحات
- **Betweenness Centrality**: تحديد نقاط الاختناق
- **Choice**: احتمالية المرور عبر العقدة
- **Control & Controllability**: قياس الهيمنة المكانية
- **Topological Depth**: العمق من المداخل

##### 2️⃣ VGA & Isovists (Benedikt/Turner)
- **Isovist Calculation**: 72 شعاع، مساحة + محيط + max radial
- **Visual Integration**: مقياس مركب للرؤية البصرية
- **Visibility Graph**: 5000 نقطة عينة
- **Blind Spots**: تحديد المناطق ذات الرؤية المنخفضة

##### 3️⃣ Agent-Based Simulation (Huang 2017)
- **4 أنواع عملاء**: معتاد (5% خطأ)، جديد (25%)، مسن (35%)، إعاقة حركية (30%)
- **50+ عميل لكل سيناريو**: محاكاة احتمالية مع نماذج معرفية
- **KPIs مُتتبعة**: أخطاء (W), تردد (H), وقت (T), معدل نجاح أول محاولة
- **سيناريوهات مستشفى**: مدخل→طوارئ، مدخل→أشعة، مدخل→صيدلية

##### 4️⃣ Signage Evaluation (Rousek & Hallbeck)
- **Coverage**: % من نقاط القرار مع لافتات (≤10م)
- **Readability**: حجم خط، تباين، إضاءة
- **Line-of-Sight**: مسافة الرؤية للافتات
- **Color Consistency**: اتساق الترميز اللوني
- **Composite Score**: SignageScore (0-100)

##### 5️⃣ WES Score (Wayfinding Efficiency Score)
```
WES = 100 - penalties + bonuses
    = 100 - α₁·T - α₂·DI - α₃·W - α₄·H 
      + β₁·VI + β₂·Signage + β₃·Accessibility
...
##### 6️⃣ Heatmaps & Recommendations
- **4 خرائط حرارية**: Betweenness, Integration, VGA, Error Hotspots
- **توصيات مُرتّبة حسب الأولوية**: Quick Wins vs Structural Changes
- **تقدير التأثير**: نسب التحسين المتوقعة
